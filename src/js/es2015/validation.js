$(document).ready(function(){
  ...
  // recover handler
  var validateSubmitRecoverHandler = function(form) {
    $(form).addClass('loading');
    ...
    $.ajax({
      ...
      complete: function(response){
        ...
        $(form).find('.profile__box__cta .btn span').text('Вернуться в форму регистрации')
        %(form).find('.profile__box__cta .profile__help-link span').text('Отправить повторно');
      }
    });
  }
